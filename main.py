...
def evaluate(frame):
	...
	protoTextPath = 'hand/pose_deploy.prototxt'
	caffemodelPath = 'hand/pose_iter_102000.caffemodel'
	inWidth = 368
	inHeight = 368
	inScale = 0.003922
	thr = 0.05
...
while True:
	...
	cv2.putText(frame, "PRESS 'SPACE' TO EVALUATE", (100, 460), cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 255, 255))
	...
	cv2.line(frame, (325, 60), (325, 418), (0, 0, 0), 2)
